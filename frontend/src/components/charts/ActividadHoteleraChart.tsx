      ...
      <ChartExportToolbar
        ...
        datosSerie={mapDatosForGammaExport(
          tab === 'historico'
            ...
            : datos.filter((d) => d.entidad_clave?.startsWith('cat:'))
        )}
        leyendaFuente="INEGI / Datatur — Estadísticas de ocupación hotelera"
        excelChartKind="column"
        onDownloadPng={() => downloadChartAsPng(chartRef, `actividad-hotelera-${tab}`)}
      />
