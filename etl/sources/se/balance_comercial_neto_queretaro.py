"""
ETL: Balance comercial neto — Querétaro (serie para sección Ciudades).

Definición usada en este tablero: exportaciones - importaciones
...
INDICADOR_CLAVE = "se.balance_comercial_neto_queretaro"
...
class BalanceComercialNetoQueretaroExtractor(BaseExtractor):
    periodicidad = "anual"
    schema = "anual"
    tabla = "datos"
    ...
    def extract(self) -> list[dict[str, Any]]:
        ...
        logger.info(
            "Serie balance comercial neto Querétaro preparada: %s registros",
            len(rows),
        )
        return rows
